...
from baselines.gradher.ddpg import DDPG
from baselines.gradher.her_sampler import make_sample_her_transitions
...
DEFAULT_PARAMS = {
    ...
    'network_class': 'baselines.gradher.actor_critic:ActorCritic',
