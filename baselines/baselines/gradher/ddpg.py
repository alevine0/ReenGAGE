...
from baselines.gradher.util import (
    import_function, store_args, flatten_grads, transitions_in_episode_batch, convert_episode_to_batch_major)
from baselines.gradher.normalizer import Normalizer
from baselines.gradher.replay_buffer import ReplayBuffer
...
class DDPG(object):
    ...
    def _create_network(self, reuse=False):
        ...
        self.Q_loss_tf = tf.reduce_mean(tf.square(target_tf - self.main.Q_tf)) -  self.grad_loss_weight*   tf.reduce_mean(batch_tf['r'] * tf.square(grad_target - grad_Q)) 
