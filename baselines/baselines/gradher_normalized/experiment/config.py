...
from baselines.gradher_normalized.ddpg import DDPG
from baselines.gradher_normalized.her_sampler import make_sample_her_transitions
...
DEFAULT_PARAMS = {
    ...
    'network_class': 'baselines.gradher_normalized.actor_critic:ActorCritic',
...
def configure_ddpg(dims, params, reuse=False, use_mpi=True, clip_return=True):
    ...
    ddpg_params.update({'input_dims': input_dims,  # agent takes an input observations
                        ...
                        'grad_loss_weight': params['grad_loss_weight']
                        })
    ddpg_params['info'] = {
